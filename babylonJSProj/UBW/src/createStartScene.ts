...
function createBlade(style: number) {
  //style 1 small style 2 semi detatched
  const bladeMat = new StandardMaterial("bladeMat");
  const faceUV: Vector4[] = []; // faces for small house
  if (style == 1) {
    bladeMat.diffuseTexture = new Texture("./assets/textures/cubehouse.png");
    ...
    bladeMat.diffuseTexture = new Texture("./assets/textures/semihouse.png");
  ...
  // Create a cylinder in the style of a needle blade instead of a box
